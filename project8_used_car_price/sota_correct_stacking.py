...
print("="*70)
print("SOTA工业级优化（修复Stacking）- 目标 MAE < 450")
print("="*70)
...
submit.to_csv('sota_correct_stacking_submit.csv', index=False)
print(f"\n✅ 结果已保存: sota_correct_stacking_submit.csv")
